...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#create-test" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="create-test" class="col-12 content scaffold-create" role="main">
                ...
                <g:form resource="${this.test}" controller="${controllerName}" method="POST">
                    <fieldset class="form">
